...
import rma.tjaksic.model.Appointment
import rma.tjaksic.model.AppointmentDatabase
import rma.tjaksic.model.AppointmentRepository
...
class AppointmentViewModel(application: Application) : AndroidViewModel(application) {
    ...
    init {
        val appointmentDao = AppointmentDatabase.Companion.getDatabase(application).appointmentDao()
